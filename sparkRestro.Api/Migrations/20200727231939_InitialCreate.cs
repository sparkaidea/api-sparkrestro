...
namespace sparkRestro.Api.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Foods",
                columns: new[] { "Id", "CategoryId", "Discount", "ImagePath", "Price", "Title" },
                values: new object[,]
                {
                    { 1, 1, 33.5, "breakfast.jpeg", 50.0, "Hot Coffee" },
                    { 2, 2, 34.5, "lunch.jpeg", 150.0, "Grilled Chicken" },
                    { 3, 1, 20.0, "supper_1.jpeg", 300.0, "Biryani" }
                });
